...
- [#172](https://github.com/alien-id/agent-id/pull/172) [`6ac3fa8`](https://github.com/alien-id/agent-id/commit/6ac3fa8ff80d2ccc1f7110032a4018013c2b21ce) Thanks [@stelchankad](https://github.com/stelchankad)! - The billing address is asked for when a checkout needs it, not when the card is
  stored.
...
- [#169](https://github.com/alien-id/agent-id/pull/169) [`058bcf5`](https://github.com/alien-id/agent-id/commit/058bcf52120c8f93cc5d34aad657a793816b38d6) Thanks [@stelchankad](https://github.com/stelchankad)! - The billing address a card is billed to.
