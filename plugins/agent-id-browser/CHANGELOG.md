...
- Updated dependencies [[`5225e57`](https://github.com/alien-id/agent-id/commit/5225e573fbcfc68cc554f43a944cf32f08f48cd5)]:
  - @alien-id/agent-id-vault@7.9.1

## 9.1.1

### Patch Changes

- [#156](https://github.com/alien-id/agent-id/pull/156) [`035e05a`](https://github.com/alien-id/agent-id/commit/035e05a05c629317dbce70f9511021f7ccce354a) Thanks [@stelchankad](https://github.com/stelchankad)! - The code card no longer states how long the code is. `otpCardSpec` sends the
...
- [#157](https://github.com/alien-id/agent-id/pull/157) [`f8f9e38`](https://github.com/alien-id/agent-id/commit/f8f9e3869ae95ce2d6087cedc542b6c996b2a7f5) Thanks [@stelchankad](https://github.com/stelchankad)! - Find the code row on a page that wraps each box more than once, and say what
...
- [#154](https://github.com/alien-id/agent-id/pull/154) [`eff4186`](https://github.com/alien-id/agent-id/commit/eff41861ca1732de91ecfa712d34d65d4e9116ee) Thanks [@stelchankad](https://github.com/stelchankad)! - A recipe is a hint, and a failed sign-in never costs the owner their credential.
...
- [#153](https://github.com/alien-id/agent-id/pull/153) [`0f5ea1f`](https://github.com/alien-id/agent-id/commit/0f5ea1f7821eacd765c0d4b6a6f70aea968b9a0c) Thanks [@stelchankad](https://github.com/stelchankad)! - `auto-login` removes a credential the owner chose not to keep (`transient`) once the sign-in has completed, and reports `credentialRemoved: true`.
...
- [#139](https://github.com/alien-id/agent-id/pull/139) [`1c5394f`](https://github.com/alien-id/agent-id/commit/1c5394f3e8a2e2aa4ed92c3bcffa1cb928dddedc) Thanks [@stelchankad](https://github.com/stelchankad)! - Ask for the code instead of failing, and say where it went.
...
- [#134](https://github.com/alien-id/agent-id/pull/134) [`f60a272`](https://github.com/alien-id/agent-id/commit/f60a272082c8bc7b123f0deb88e61a6e8f09920c) Thanks [@stelchankad](https://github.com/stelchankad)! - Stop reading a staged password field as one the site is asking for.
